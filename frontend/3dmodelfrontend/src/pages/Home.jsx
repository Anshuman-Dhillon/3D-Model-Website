...
function Home() {
    return (
        <div style={{ position: 'relative', width: '100%', minHeight: '100vh' }}>
            ...
            <div className="home-header-overlay" style={{background: 'rgba(255,255,255,0.0)', position: 'absolute', top: '-2vh', left: 0, width: '100%', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', pointerEvents: 'none'}}>
